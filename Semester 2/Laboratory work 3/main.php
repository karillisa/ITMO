            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Мои тесты</h1>
                    </div>
                    <a href="tests/test.php?id=<?= (isset($tests[0]['id'])?$tests[0]['id']:"") ?>" class="btn btn-success btn-icon-split mb-5">
                            ...
                            <div class="collapse show" id="collapseCardExample<?= $test['id'] ?>">
                                <div class="card-body">
                                    ...
                                    <div class="progress mb-4">
                                        <div class="progress-bar bg-success" role="progressbar" style="width: <?= $result['result']/$max*100 ?>%"
                                             aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <?php endforeach; ?>

                                    <h5 class="font-weight-bold mt-4">Динамика: <?= (($dynamic>=0)?"+":"-").abs($dynamic) ?> мс (<?= (($dynamic>=0)?"ухудшилась":"улучшилась") ?> на <?= abs($dynamic_percent) ?>%)</h5>
