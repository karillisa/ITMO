            ...
            <?php include("scripts/menu_top.php") ?>
                ...
                <div id="pvk_wrapper" class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Редактирование времени тестов</h1>
                    </div>
                    <form action="./scripts/save_tests_tiems.php" method="post">
                    <?php foreach($tests as $test){ ?>
                    <div class="row col-md-6 mt-4">
                            <h5 class="m-0 col-4 font-weight-bold text-primary pvk_name"><?= $test['title'] ?></h5>
                            <input type="number" class="form-control col-5" name="time[<?= $test['id'] ?>]" value="<?= $test['time'] ?>" placeholder="Время">
                    </div>
                    <?php } ?>
