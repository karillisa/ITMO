...
INSERT INTO `tests` VALUES (1,'Тест на cвет','old_tests/light.php',4,'ms'),(2,'Тест на сложение в уме (звук)','old_tests/count_sound.php',4,'ms'),(3,'Тест скорости реакции на разные цвета','old_tests/colors.php',4,'ms'),(4,'Тест на звук','old_tests/sound.php',4,'ms'),(5,'Тест на сложение в уме (визуально)','old_tests/count_visual.php',4,'ms'),(6,'Простая РДО','old_tests/simple_rdo.php',4,'ms'),(7,'Сложная РДО','old_tests/hard_rdo.php',4,'ms'),(8,'Аналоговое слежение','old_tests/analog_tracking.php',4,'ms'),(9,'Аналоговое преследование','old_tests/analog_pursuit.php',4,'ms'),(10,'Красно-черные таблицы Горбова-Шульте','red_black_tables.php',1,'ms'),(11,'Кольца Ландольта','rings.php',1,'ms'),(12,'Тест кратковременной памяти на слова','words.php',2,'pc'),(13,'Тест кратковременной памяти на образы','images.php',2,'pc'),(14,'Арифметические операции','arithmetic.php',3,'pc'),(15,'Кубики Косса','cubes.php',3,'pc'),(16,'Установление закономерностей','patterns.php',3,'pc');
...
INSERT INTO `users` VALUES (1,'Михаил','Мороз','moroz.mkhl@gmail.com','a1c62a848f2e67cb25a71ca72f6585e0',2,NULL,50,0),(16,'Михаил2','Мороз2','aaa@aaa.aa','a1c62a848f2e67cb25a71ca72f6585e0',2,NULL,45,0);
...
-- Dump completed on 2024-05-12  2:18:43
