            ...
            <?php include("scripts/menu_top.php") ?>
                ...
                <div id="pvk_wrapper" class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Ссылка сгенерирована</h1>
                    </div>
                    <div class="mb-6">
                        <h2 class="h3 mb-0 text-gray-800">Пользователь: <?= $user['name']." ".$user['second_name'] ?></h2>
                        <h3></h3>
                        <h3>Отправьте следующую ссылку респонденту:</h3>
                        <h4>http://<?= $_SERVER['SERVER_NAME'].'/tests/test.php?link='.$user['invitation_link'] ?></h4>
                    </div>
