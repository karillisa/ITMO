...
public class SpaceMarine implements Comparable<SpaceMarine> {
    ...
    public SpaceMarine(Long id, String name, Coordinates coordinates, LocalDateTime creationDate, Integer health, boolean loyal, Weapon weaponType, MeleeWeapon meleeWeapon, Chapter chapter, int userID) {
        this.id = id;
    ...
    public IdController getIdCnt() {
        return idCnt;
    }

    public void setIdCnt(IdController idCnt) {
        this.idCnt = idCnt;
    }
