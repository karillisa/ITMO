...
__Комментарии по выполнению ЛР:__
...
- Веб-сервер должен заниматься обслуживанием статического контента (html, css, js) и перенапрявлять запросы за динамическим контентом к `FastCGI` серверу
...
- При работе с CSS должно быть продемонстрировано использование селекторов псевдоклассов, селекторов элементов, селекторов потомств, селекторов псевдоэлементов а также такие свойства стилей CSS, как наследование и каскадирование.
...
- изменение X: Radio {'-3', '-2', '-1', '0', '1', '2', '3', '4', '5'}
